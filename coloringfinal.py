...
# Modify this code to run your optimization algorithm
    ...
    if node_count == 1000:
        ...
        while True:
            ...
            if time.time() >= finish_time:
                print("Jumping one color up. To color %i" % k)
                k = k + 1
                continue
            ...
            if status == cp_model.INFEASIBLE:
                print("Infeasible with colors: %i" %k )
                k = k + 1
    ...
    if node_count == 250:
        ...
        k = int((edge_count / node_count) - 35)
    ...
    if node_count < 250:     
        ...
        while True:
            ...
            if time.time() >= finish_time:
                ...
                solution = []
                checker_var = 1
                print("This is FEASIBLE solution." + " Number of colors: %i" % k)
                for i in nodes:
                    i = solver.Value(i)
                    solution.append(i)
                break
